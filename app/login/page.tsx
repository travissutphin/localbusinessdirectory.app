        ...
        <div className="card-dark text-white">
          ...
          {comingSoon && (
            <div className="mb-6 p-4 bg-amber-900/20 border border-amber-500/30 rounded-lg flex items-center gap-3">
              ...
              <p className="text-amber-300 text-sm">{comingSoon} sign-in coming soon!</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="/forgot-password" className="text-sm text-secondary-400 hover:text-secondary-500">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
