...
export default function AboutPage() {
  ...
  const webPageSchema = {
    ...
    about: {
      '@type': 'Thing',
      name: 'Home-Based Business Directory Services',
      description: 'Free business listing services for home-based entrepreneurs including SEO optimization, Schema.org markup, and local search visibility.',
    },
    mainEntity: {
      '@type': 'Service',
      ...
      offers: {
        ...
        price: '0',
        priceCurrency: 'USD',
        description: 'Free forever - no hidden fees or premium tiers',
      },
    },
  }
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        '@type': 'Question',
        name: 'How does the SEO optimization work?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Every business listing includes Schema.org LocalBusiness structured data markup, optimized meta titles and descriptions, canonical URLs, and mobile-friendly design. This helps search engines like Google understand and rank your business.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'AEO optimizes your business information for AI assistants like ChatGPT, Google AI, and Siri. When customers ask AI for local business recommendations, your structured data helps AI understand and suggest your services.',
        },
      },
      {
        '@type': 'Question',
        name: 'How long does it take to set up a listing?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Most business owners complete their listing in about 3 minutes. Simply register, add your business details, and submit for approval.',
        },
      },
    ],
  }
        ...
        <section className="py-20 md:py-32 bg-gradient-to-b from-white via-primary-50/30 to-white relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              {/* SEO Card */}
              <article className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-neutral-100 hover:border-primary-200 relative overflow-hidden">
              ...
              {/* AEO Card */}
              <article className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-neutral-100 hover:border-purple-200 relative overflow-hidden">
              ...
              {/* GEO Card */}
              <article className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-neutral-100 hover:border-green-200 relative overflow-hidden">
